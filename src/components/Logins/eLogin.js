...
class ELogin extends Forms {
  ...
  <div style = {{height: '100%', position: "absolute", left: '0', width: '100%',overflow: 'hidden'}} className="header bg-gradient-purple py-7 py-lg-3 ">
          ...
          <CardBody className="px-lg-5 py-lg-5">
            ...
            <Form role="form" onSubmit={this.handleSubmit}>
              ...
              <div className="text-center">
                <Button disabled={this.state.loadstatus} style={{background: '#F5365C', border: 'none'}} className="my-4" color="primary" type="submit">
                  Sign in
                </Button>
              </div>
            </Form>
